"""Task-owned data preparation for score prediction."""
...
def run_prepare(task_cfg: DictConfig, prepare_cfg: DictConfig) -> None:
    """Prepare manifests for score prediction."""
...
def _build_manifest_df(labels_df: pd.DataFrame) -> pd.DataFrame:
    ...
    manifest_df = apply_processors(manifest_df, MANIFEST_PROCESSORS)
