...
from aitraf_train.storage import clips as clips_module
from aitraf_train.storage.clips import ClipDownloadRequest, download_clip, download_clips
...
def test_download_clip_downloads_missing_file(tmp_path: Path) -> None:
    ...
    assert client.downloads == [("aitraf", "clips/sample.mp4")]
