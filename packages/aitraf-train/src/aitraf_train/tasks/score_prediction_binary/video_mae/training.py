"""VideoMAE fine-tuning pipeline for binary score prediction."""
...
@dataclass
class VideoMaeScorePredictionBinaryTrainCfg:
    """Configuration for VideoMAE binary score-prediction training."""
...
def run_training(config: VideoMaeScorePredictionBinaryTrainCfg) -> str:
    """Train the VideoMAE binary classifier and log artifacts to MLflow."""
...
__all__ = ["VideoMaeScorePredictionBinaryTrainCfg", "run_training"]
