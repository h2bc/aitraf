...
import aitraf_ml_core.loading.mlflow as mlflow_loading
...
def test_mlflow_transformers_device_rejects_unknown_device():
    with pytest.raises(RuntimeError, match="Unsupported MLflow transformers device"):
        mlflow_loading._mlflow_transformers_device("mps")
